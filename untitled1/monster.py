...
MONSTER_WIDTH=32
MONSTER_HEIGHT=32
MONSTER_COLOR="yellow"
ICON_DIR=os.path.dirname(__file__)#повний путь до катологу з файлами

ANIMATION_MONSTERHORYSONTAL=[('%s/monsters/s11.png' % ICON_DIR),('%s/monsters/s22.png' %ICON_DIR)]
